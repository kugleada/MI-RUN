 ...
 *
 */
public class TSchemeException extends RuntimeException {
    private static final long serialVersionUID = 1L;

    public TSchemeException(String message) {
        super(message);
    }
    ...
    public static Throwable fillInMumblerStackTrace(Throwable t) {
        ...
        Truffle.getRuntime().iterateFrames(new FrameInstanceVisitor<Void>() {
            ...
            public Void visitFrame(FrameInstance frame) {
                ...
                if (root instanceof TSchemeRootNode) {
                    methodName = ((TSchemeRootNode) root).name;
                }
                ...
                stackTrace.add(new StackTraceElement("tscheme", methodName, sourceName, lineNumber));
                return null;
            }
        });
