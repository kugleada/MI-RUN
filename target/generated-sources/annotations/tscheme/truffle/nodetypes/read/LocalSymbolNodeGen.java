...
@GeneratedBy(LocalSymbolNode.class)
public final class LocalSymbolNodeGen extends LocalSymbolNode {

    private final FrameSlot slot;
    @CompilationFinal private int state_ = 1;
    @CompilationFinal private int exclude_;

    private LocalSymbolNodeGen(FrameSlot slot) {
        this.slot = slot;
    }
    ...
    public static LocalSymbolNode create(FrameSlot slot) {
        return new LocalSymbolNodeGen(slot);
    }
