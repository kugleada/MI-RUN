...
@GeneratedBy(DivBuiltInNode.class)
@SuppressWarnings({"unchecked", "rawtypes"})
public final class DivBuiltInNodeFactory implements NodeFactory<DivBuiltInNode> {

    private static DivBuiltInNodeFactory instance;

    private DivBuiltInNodeFactory() {
    }

    @Override
    public Class<DivBuiltInNode> getNodeClass() {
        return DivBuiltInNode.class;
    }
    ...
    @Override
    public DivBuiltInNode createNode(Object... arguments) {
    ...
    public static NodeFactory<DivBuiltInNode> getInstance() {
        if (instance == null) {
            instance = new DivBuiltInNodeFactory();
        }
        return instance;
    }

    public static DivBuiltInNode create(TSchemeNode[] arguments) {
        return new DivBuiltInNodeGen(arguments);
    }

    @GeneratedBy(DivBuiltInNode.class)
    public static final class DivBuiltInNodeGen extends DivBuiltInNode {

        @Child private TSchemeNode arguments0_;
        @Child private TSchemeNode arguments1_;
        @CompilationFinal private int state_ = 1;

        private DivBuiltInNodeGen(TSchemeNode[] arguments) {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            int state = state_;
            if ((state & 0b1101) == 0 /* only-active divide(long, long) */) {
                return executeGeneric_long_long0(frameValue, state);
            } else if ((state & 0b111) == 0 /* only-active divide(double, double) */) {
        ...
        private Object executeGeneric_long_long0(VirtualFrame frameValue, int state) {
            ...
            assert (state & 0b10) != 0 /* is-active divide(long, long) */;
            return divide(arguments0Value_, arguments1Value_);
        }
        ...
        private Object executeGeneric_double_double1(VirtualFrame frameValue, int state) {
            ...
            assert (state & 0b1000) != 0 /* is-active divide(double, double) */;
            return divide(arguments0Value_, arguments1Value_);
        }
        ...
        private Object executeGeneric_generic2(VirtualFrame frameValue, int state) {
            ...
            if ((state & 0b10) != 0 /* is-active divide(long, long) */ && arguments0Value_ instanceof Long) {
                ...
                if (arguments1Value_ instanceof Long) {
                    ...
                    return divide(arguments0Value__, arguments1Value__);
                }
            }
            if ((state & 0b100) != 0 /* is-active divide(BigInteger, BigInteger) */ && TSchemeDataTypesGen.isImplicitBigInteger((state & 0b110000) >>> 4 /* extract-implicit-active 0:BigInteger */, arguments0Value_)) {
            ...
            if ((state & 0b1000) != 0 /* is-active divide(double, double) */ && TSchemeDataTypesGen.isImplicitDouble((state & 0b11100000000) >>> 8 /* extract-implicit-active 0:double */, arguments0Value_)) {
        ...
        public double executeDouble(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            if ((state & 0b1000) != 0 /* is-active divide(double, double) */) {
                return divide(arguments0Value_, arguments1Value_);
            }
            CompilerDirectives.transferToInterpreterAndInvalidate();
        ...
        public long executeLong(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            if ((state & 0b10) != 0 /* is-active divide(long, long) */) {
                return divide(arguments0Value_, arguments1Value_);
            }
            CompilerDirectives.transferToInterpreterAndInvalidate();
            ...
            try {
                ...
                if (arguments0Value instanceof Long) {
                    ...
                    if (arguments1Value instanceof Long) {
                        ...
                        this.state_ = state | 0b10 /* add-active divide(long, long) */;
                        lock.unlock();
                        hasLock = false;
                        return divide(arguments0Value_, arguments1Value_);
                    }
                }
                {
                    ...
                    if ((bigIntegerCast0 = TSchemeDataTypesGen.specializeImplicitBigInteger(arguments0Value)) != 0) {
                        ...
                        if ((bigIntegerCast1 = TSchemeDataTypesGen.specializeImplicitBigInteger(arguments1Value)) != 0) {
                            ...
                            this.state_ = state | 0b100 /* add-active divide(BigInteger, BigInteger) */;
                            lock.unlock();
                            hasLock = false;
                            return divide(arguments0Value_, arguments1Value_);
                        }
                ...
                }
                {
                    ...
                    if ((doubleCast0 = TSchemeDataTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
                        ...
                        if ((doubleCast1 = TSchemeDataTypesGen.specializeImplicitDouble(arguments1Value)) != 0) {
                            ...
                            this.state_ = state | 0b1000 /* add-active divide(double, double) */;
                            lock.unlock();
                            hasLock = false;
                            return divide(arguments0Value_, arguments1Value_);
                        }
