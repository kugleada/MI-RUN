...
public final class SubBuiltInNodeFactory implements NodeFactory<SubBuiltInNode> {
    ...
    public static final class SubBuiltInNodeGen extends SubBuiltInNode {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            int state = state_;
            if ((state & 0b1101) == 0 /* only-active minus(long, long) */) {
                return executeGeneric_long_long0(frameValue, state);
            } else if ((state & 0b111) == 0 /* only-active minus(double, double) */) {
        ...
        private Object executeGeneric_generic2(VirtualFrame frameValue, int state) {
            ...
            if ((state & 0b100) != 0 /* is-active minus(BigInteger, BigInteger) */ && TSchemeDataTypesGen.isImplicitBigInteger((state & 0b110000) >>> 4 /* extract-implicit-active 0:BigInteger */, arguments0Value_)) {
            ...
            if ((state & 0b1000) != 0 /* is-active minus(double, double) */ && TSchemeDataTypesGen.isImplicitDouble((state & 0b11100000000) >>> 8 /* extract-implicit-active 0:double */, arguments0Value_)) {
        ...
        public double executeDouble(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            if ((state & 0b1000) != 0 /* is-active minus(double, double) */) {
                return minus(arguments0Value_, arguments1Value_);
            }
            CompilerDirectives.transferToInterpreterAndInvalidate();
